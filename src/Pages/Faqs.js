        ...
        <div className="space-y-">
          ...
          <div class="panel pt-3">
            <p>
              ...
              protocol ensures that BinaryBlock asset holders receive a portion
              of crypto daily. This process allows asset holders to earn crypto
          ...
          <div class="panel pt-3">
            <p>
              ...
              to earn crypto for over 20 years. It is a valuable asset that also
          ...
          <div class="panel pt-3">
            <p>
              ...
              interacting with protocol and access to the core functionalities
              of the ecosystem.
            </p>
          </div>
          ...
          <div class="panel pt-3">
            <p>
              ...
              earning opportunities through BinaryBlock asset staking, trading,
              lending, and interacting with the protocol using BIBK.
            </p>
          </div>
          ...
          <div class="panel pt-3">
            <p>
              Rewards on the BinaryBlock platform are distributed on a daily
              basis to stakers who have staked BIBK or NFTs into the protocol
              smart contract.
            </p>
          </div>
          ...
          <div class="panel pt-3">
            <p>
              ...
              digital information in computing. It is represented as either a 0
              or a 1 and is used to store and transmit data in the binary number
              system.
            </p>
          </div>
          ...
          <div class="panel pt-3">
            <p>
              The binary system is a base-2 numbering system, where each digit
              can only have two possible values, 0 or 1. In contrast, the
              decimal system is a base-10 numbering system that uses 10 digits
          ...
          <div class="panel pt-3">
            <p>
              ...
              that benefits all stakeholders, including NFT holders, BIBK
              holders, and the wider crypto community.
            </p>
          </div>
          ...
          <div class="panel pt-3">
            <p>
              ...
              the protocol. Once staked, the NFTs are locked for a certain
              period, and crypto is earned on the staked NFTs while still in the
              holders’ wallets.
            </p>
          </div>
