  ...
  const [team, setTeam] = useState([
    {
      ...
      experience:
        ...
        link:  <a href="https://www.linkedin.com/in/godspower-egbetamah/" target="_blank" className=""> <BsLinkedin className="hover:cursor-pointer text-3xl xl:text-4xl xl:p-2 p-1 text-black bg-white rounded-full"/></a>,
    },
    {
      ...
      experience:
        ...
        link:<a href="https://www.linkedin.com/in/ezekiel-cliffy-egbetamah-541627104" target="_blank" className=""><BsLinkedin className="hover:cursor-pointer text-3xl xl:text-4xl xl:p-2 p-1 text-black bg-white rounded-full"/></a>,
    },
    {
      name: "Ishan Dua",
    ...
    
    {
      ...
      link:<a href="https://www.linkedin.com/in/saint-daniel-a2a308180" target="_blank" className=""><BsLinkedin className="hover:cursor-pointer text-3xl xl:text-4xl xl:p-2 p-1 text-black bg-white rounded-full"/></a> ,
    },
    {
      ...
      link:<a href="https://www.linkedin.com/in/emmanuel-anofienem" target="_blank" className=""> <BsLinkedin className="hover:cursor-pointer text-3xl xl:text-4xl xl:p-2 p-1 text-black bg-white rounded-full"/></a>,
    },
    {
      name: "AZHAR SIDDIQUI",
      ...
      link: <a href="https://www.linkedin.com/in/azharsiddiquii" target="_blank" className=""><BsLinkedin className="hover:cursor-pointer text-3xl xl:text-4xl xl:p-2 p-1 text-black bg-white rounded-full"/></a>,
    },
    {
      name: "Tochukwu Tagbo",
      ...
      link:<a href="https://www.linkedin.com/in/tochukwu-tagbo-4173361b" target="_blank" className=""><BsLinkedin className="hover:cursor-pointer text-3xl xl:text-4xl xl:p-2 p-1 text-black bg-white rounded-full"/></a>,
    },
  ]);
